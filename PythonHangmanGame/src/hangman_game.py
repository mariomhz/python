...
class HangmanGame:
    def __init__(self, master):
        ...
        self.master.configure(bg='#b2d8b5') 
    ...
    def initialize_gui(self):
        ...
        self.hangman_canvas = tk.Canvas(self.master, width=300, height=300, bg="#b2d8b5")  # Canvas with light green bg
        self.hangman_canvas.pack(pady=20)
        self.word_display = tk.Label(self.master, text="_ " * len(self.secret_word), font=("Helvetica", 30), bg='#c5e6b2')  # Pale green background
    ...
    def draw_head(self):
        self.hangman_canvas.create_oval(125, 50, 185, 110, outline="green")

    def draw_body(self):
        self.hangman_canvas.create_line(155, 110, 155, 170, fill="green")

    def draw_left_arm(self):
        self.hangman_canvas.create_line(155, 130, 125, 150, fill="green")

    def draw_right_arm(self):
        self.hangman_canvas.create_line(155, 130, 185, 150, fill="green")

    def draw_left_leg(self):
        self.hangman_canvas.create_line(155, 170, 125, 200, fill="green")

    def draw_right_leg(self):
        self.hangman_canvas.create_line(155, 170, 185, 200, fill="green")

    def draw_face(self):
        self.hangman_canvas.create_line(140, 70, 150, 80, fill="green")
        self.hangman_canvas.create_line(160, 70, 170, 80, fill="green")
        self.hangman_canvas.create_arc(140, 85, 170, 105, start=0, extent=-180, fill="green")
    ...
    def check_game_over(self):
        if set(self.secret_word).issubset(self.correct_guesses):
            self.display_game_over_message("Congratulations!")
    ...
    def display_game_over_message(self, message):
        ...
        self.game_over_label = tk.Label(self.master, text=message, font=stylish_font, fg="#2e8b57", bg='#c5e6b2')  # Darker green text
